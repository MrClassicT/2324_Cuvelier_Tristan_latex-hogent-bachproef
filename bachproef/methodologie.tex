...
Deze \acrlong{POC} werd opgesplitst in meerdere fasen. Voor het onderzoeken en effectief opstellen van hiervan waren enkel toegang tot een computer, technisch inzicht en logisch redeneren vereist. Het doel was om een open-source \acrlong{POC} te bekomen die kon dienen als basis om een effectieve volledig functionele linter op verder uit te bouwen.
...
Een kijk naar hoe een linter \emph{echt} werkte. Deze kennis werd gebruikt als inspiratiebron voor het uiteindelijke \acrlong{POC} dat opgesteld werd in een latere fase. 
...
Tot slot wordt er nog een conclusie getrokken waarin er bepaald wordt in hoeverre deze \acrlong{POC} een succes was. Er zal gekeken worden naar de opgeleverde functionaliteiten en zal er gekeken worden tot in hoeverre er aan de niet-functionele requirements voldaan werd. Alsook de overblijvende werkpunten zullen er besproken worden, samen met de toekomst visie van deze \acrlong{POC}.