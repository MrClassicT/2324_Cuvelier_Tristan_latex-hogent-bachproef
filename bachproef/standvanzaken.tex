...
Artificiële Intelligentie gaat al langer mee dan de meeste denken, al sinds de jaren vijftig \autocite{Ida2024}. De geschiedenis zal hier niet besproken worden, maar voor het maken van linters is het interessant om de moderne capaciteiten van Artificiële Intelligentie (AI) uit te testen en met het nut ervan te experimenteren.

Dankzij zijn vermogen om zelfstandig te leren, is artificiële intelligentie steeds beter in staat om menselijke activiteiten uit te voeren en met succes af te ronden \autocite{Khamis2024}. Ook bij het programmeren van software-tools is dit de dag van vandaag het geval.

In dit onderzoek werd er AI toegepast en zullen er enkele use cases toegelicht worden waarin het nut van AI duidelijk wordt.